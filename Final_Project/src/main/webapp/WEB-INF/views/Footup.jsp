			...
			<main>
							...
							<div class="upload-box">
								<div id="drop-file2" class="drag-file">
									<img src="https://img.icons8.com/pastel-glyph/2x/image-file.png" alt="파일 아이콘"
										class="image">
									<p class="message">파일 업로드 하기</p>
									<img src="" alt="미리보기 이미지" class="preview2" id="output2">
								</div>
								<div class="choose_upload">
									<label class="file-label" for="chooseFile2">Choose File</label>
									<input class="file" id="chooseFile2" type="file"
										onchange="dropFile2.handleFiles2(this.files)"
										accept="image/png, image/jpeg, image/gif">
				...
				<div class="grid Upload">
						...
						<div class="contents">
							<div class="upload-box">
								...
								<div class="choose_upload">
									...
									<input class="file" id="chooseFile3" type="file"
										onchange="dropFile3.handleFiles3(this.files)"
										accept="image/png, image/jpeg, image/gif">
					...
					<div id="root">
						<div class="contents">
							<div class="upload-box">
								<div id="drop-file4" class="drag-file">
									<img src="https://img.icons8.com/pastel-glyph/2x/image-file.png" alt="파일 아이콘"
										class="image">
									<p class="message">파일 업로드 하기</p>
								...
								<div class="choose_upload">
									...
									<input class="file" id="chooseFile4" type="file"
										onchange="dropFile4.handleFiles4(this.files)"
										accept="image/png, image/jpeg, image/gif">
